...
const FAQS = [
  {
    ...
    a: "No! Most of our Riverside clients are at work, running errands, or relaxing. You can provide entry instructions (e.g. front door keypad code, lockbox, or key under mat) during booking. Our team will secure your home and send photo confirmation once finished.",
  },
  {
    ...
    <section className="py-20 bg-slate-50 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 p-6 rounded-2xl bg-white border border-slate-200 shadow-sm text-center sm:flex sm:items-center sm:justify-between sm:text-left gap-4">
          <div>
            <h4 className="font-bold text-slate-900 text-sm">Have a unique Riverside estate or commercial property?</h4>
            <p className="text-xs text-slate-500 mt-0.5">Our Riverside concierge is ready to tailor a custom scope.</p>
          </div>
